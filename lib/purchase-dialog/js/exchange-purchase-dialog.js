...
jQuery( document ).ready( function( $ ) {
	...
	$('#it-exchnage-purchase-dialog-cc-number-for-authorizenet').it_exchange_detect_credit_card_type({ 'element' : '#it-exchnage-purchase-dialog-cc-number-for-authorizenet' });
});
