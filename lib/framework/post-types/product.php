<?php
/**
 * CartBuddy Products Post Type class.
 *
 * Sets up the products post type.
 *
 * @package IT_CartBuddy
 * @since 0.1
*/

if ( ! class_exists( 'IT_CartBuddy_Products' ) ) {
	...
	class IT_CartBuddy_Products extends ITPostType {
		...
		*/
		var $_settings = array(
			'rewrite'             => array(
				'slug' => 'post-type-cartbuddy-product',
			),
		...
		*/
		 ...
		 * @since 0.1
		*/
		function IT_CartBuddy_Products( &$parent ) {
			$this->_parent = &$parent;
			IT_CartBuddy_Products::ITPostType();
			if ( is_admin() ) {
		...
		*/
		function register_meta_boxes() {
			$meta_boxes = apply_filters( 'it_cartbuddy-product_metaboxes', array() );
		...
		*/
		function register_admin_pages() {
			...
			// Add pages
			$pages = apply_filters( 'it_cartbuddy-admin_pages', $pages );
		...
		*/
		function register_admin_page_tabs() {
			$this->_page_tabs = apply_filters( 'it_cartbuddy-admin_tabs', array() ); 
		}
	...
	new IT_CartBuddy_Products( &$this );
}
