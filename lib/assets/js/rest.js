(function ( Schemas, ExchangeCommon, $, _, Backbone, wp, Config ) {
	...
	app.Models.Customer = app.Model.extend( {
		...
		_billingAddress: function ( data, model ) {
			return new app.Models.Address( data, {
		...
		billingAddress: function () {
			...
			if ( !this.get( 'billing_address' ) ) {
				return null;
			}

			if ( !this._billingAddress instanceof app.Models.Address ) {
				this._billingAddress = new app.Models.Address( { id: this.get( 'billing_address' ) }, {
		...
		shippingAddress: function () {
			...
			if ( !this._shippingAddress instanceof app.Models.Address ) {
				this._shippingAddress = new app.Models.Address( { id: this.get( 'shipping_address' ) }, {
					collection: this.addresses(),
					context   : this.context,
				} );
			}
