(function ( api, Common, $, _, APIConfig, ProfileConfig ) {
	...
	app.Views.ManageAddresses = api.View.extend( {
		...
		initialize: function ( options ) {
			...
			this.listenTo( this.model.addresses(), 'add', function ( address ) {
				this.views.add( '.it-exchange-customer-addresses-container', new app.Views.ManageAddressesAddress( {
					model : address,
					parent: this,
				} ) );
			} );

			this.model.addresses().fetch();
