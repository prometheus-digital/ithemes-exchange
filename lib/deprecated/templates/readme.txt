/**
 * These templates are deprecated as of Exchagne 1.1.0
 * Theme developers are encourage to upgrade to the new
 * template parts API so that Exchange add-ons may integrate
 * with your theme.
 *
