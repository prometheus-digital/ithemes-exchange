...
function it_exchange_register_core_pages() {
	...
	$options = array(
		...
		'tip'           => __( 'Where customer register to login and download, etc. You can turn off registration and allow guest checkout in Exchange / Add-Ons.', 'LION' ),
		'type'			=> 'exchange',
		'menu'			=> true,
		'optional'      => true,
	);
	...
	$options = array(
		...
		'tip'           => __( 'Customers get an account when they buy something, so they can login and download their purchases. This is the main landing page for customers to they login.', 'LION' ),
		'type'			=> 'exchange',
		'menu'			=> true,
		'optional'      => false,
	);
