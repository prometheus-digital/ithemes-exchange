...
<div class="it-exchange-transaction-meta">
	...
	<?php foreach( it_exchange_get_template_part_elements( 'content_confirmation', 'transaction_meta', array( 'message', 'order-details-label', 'order-number', 'date', 'total', 'status', 'instructions' ) ) as $meta ) : ?>
