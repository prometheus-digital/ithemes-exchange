...
<?php if ( it_exchange( 'transaction', 'has-products' ) ) : ?>
	...
	<div class="it-exchange-transaction-summary-loop">
		 <?php foreach( it_exchange_get_template_part_elements( 'content_confirmation', 'transaction_summary', array( 'totals-subtotal', 'totals-savings', 'totals-total' ) ) as $total ) : ?>
