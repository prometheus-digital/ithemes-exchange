...
<?php do_action( 'it_exchange_content_registration_fields_before_loop' ); ?>
	...
	<div class="customer-info">
		<?php foreach ( it_exchange_get_template_part_elements( 'content_registration', 'fields', array( 'username', 'first-name', 'last-name', 'email', 'password1', 'password2' ) ) as $detail ) : ?>
			<?php
			/** 
