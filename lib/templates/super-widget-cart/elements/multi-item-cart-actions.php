...
<?php do_action( 'it_exchange_super_widget_cartbefore_multi_item_actions_wrapper' ); ?>
<div class="cart-actions-wrapper two-actions">
	<?php do_action( 'it_exchange_super_widget_cart_begin_multi_item_actions_wrapper' ); ?>
	...
	<?php do_action( 'it_exchange_super_widget_cart_end_multi_item_actions_wrapper' ); ?>
</div>
<?php do_action( 'it_exchange_super_widget_cart_after_multi_item_actions_wrapper' ); ?>
