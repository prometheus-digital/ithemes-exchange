...
<?php foreach( it_exchange_get_template_part_elements( 'content_product', 'features', array( 'base-price', 'description', 'super-widget' ) ) as $detail ): ?>
	<?php it_exchange_get_template_part( 'content-product/features/' . $detail ); ?>
<?php endforeach; ?>
