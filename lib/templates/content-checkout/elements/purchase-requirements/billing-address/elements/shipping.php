...
*/
?>
<?php do_action( 'it_exchange_content_checkout_billing_address_purchase_requirement_before_billing_element' ); ?>
<div class="it-exchange-billing">
	<?php it_exchange( 'billing', 'shipping' ); ?>
</div>
<?php do_action( 'it_exchange_content_checkout_billing_address_purchase_requirement_after_billing_element' ); ?>
