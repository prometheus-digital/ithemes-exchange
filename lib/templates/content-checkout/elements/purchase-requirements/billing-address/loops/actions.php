...
<?php foreach ( it_exchange_get_template_part_elements( 'content_checkout/elements/purchase-requirements/billing-address/elements/', 'actions', array( 'submit', 'cancel' ) ) as $action ) : ?>
	<?php 
	/** 
