...
<?php do_action( 'it_exchange_content_registration_begin_actions_loop' ); ?>
	<?php foreach ( it_exchange_get_template_part_elements( 'content_checkout/elements/purchase-requirements/logged-in/elements/registration/', 'actions', array( 'save', 'login', 'cancel' ) ) as $action ) : ?>
		<?php
		/**
