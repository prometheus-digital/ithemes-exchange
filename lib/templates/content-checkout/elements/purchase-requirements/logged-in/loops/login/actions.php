...
<?php foreach ( it_exchange_get_template_part_elements( 'content_checkout/elements/purchase-requirements/logged-in/elements/login/', 'actions', array( 'login-button', 'recover', 'register', 'cancel' ) ) as $action ) : ?>
	<?php 
	/** 
