 ...
 * Registration purchase requirement element in the content-checkout
 * template part.
 *
 * @since 1.1.3
 * @version 1.1.3
...
*/
?>
<?php do_action( 'it_exchange_content_checkout_before_login_purchase_requirement_element' ); ?>
<div class="it-exchange-checkout-login-purchase-requirement">
	<?php if ( ! is_user_logged_in() ) : ?>
		...
		<div class="it-exchange-hidden checkout-purchase-requirement-login">
			...
			<div class="it-exchange-login-form">
				<?php 
				do_action( 'it_exchange_content_login_before_form' );
				it_exchange( 'login', 'form-open' );
				do_action( 'it_exchange_content_login_begin_form' );
				...
				endforeach;
				do_action( 'it_exchange_content_login_end_form' );
		...
		<div class="it-exchange-hidden checkout-purchase-requirement-registration">
        	...
        	if ( it_exchange( 'registration', 'is-enabled' ) ) :
				do_action( 'it_exchange_content_registration_before_form' );
				...
				do_action( 'it_exchange_content_registration_after_form' );
        	endif;
			?>	
		</div>
	<?php else : ?>
...
<?php do_action( 'it_exchange_content_checkout_after_login_purchase_requirement_element' ); ?>
