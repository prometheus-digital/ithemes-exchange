...
<?php do_action( 'it_exchange_content_cart_before_line_items' ); ?>
	<div id="it-exchange-line-items" class="it-exchange-table">
		<?php do_action( 'it_exchange_content_cart_before_line_items_loop' ); ?>

		<?php while ( it_exchange( 'cart', 'line-items', array( 'without' => 'product' ) ) ): ?>
			<?php do_action( 'it_exchange_content_cart_begin_line_items_loop' ); ?>
			...
			<?php do_action( 'it_exchange_content_cart_end_line_items_loop' ); ?>
		<?php endwhile; ?>

		<?php do_action( 'it_exchange_content_cart_after_line_items_loop' ); ?>
	</div>
<?php do_action( 'it_exchange_content_cart_after_line_items' ); ?>