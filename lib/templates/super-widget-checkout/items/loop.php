...
<div class="cart-items-wrapper">
	...
	<?php while( it_exchange( 'cart', 'cart-items' ) ) : ?>
		...
		<div class="cart-item">
			...
			<div class="title-remove">
				<?php foreach( it_exchange_get_template_part_slugs( 'super_widget_checkout', 'items', array( 'title', 'remove' ) ) as $detail ) : ?>
					<?php it_exchange_get_template_part( 'super-widget-checkout/items/details/' . $detail ); ?>
				<?php endforeach; ?>
			</div>
			<div class="item-info">
				<?php foreach( it_exchange_get_template_part_slugs( 'super_widget_checkout', 'items', array( 'price' ) ) as $detail ) : ?>
					<?php it_exchange_get_template_part( 'super-widget-checkout/items/details/' . $detail ); ?>
				<?php endforeach; ?>
			</div>
	...
	if ( it_exchange( 'coupons', 'has-applied', array( 'type' => 'cart' ) ) )
		it_exchange_get_template_part( 'super-widget-checkout/discounts/loop' );
	?>
