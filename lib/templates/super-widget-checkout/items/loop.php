	...
	<?php while( it_exchange( 'cart', 'cart-items' ) ) : ?>
		...
		<div class="cart-item">
			...
			<div class="title-remove">
				<?php foreach( it_exchange_get_super_widget_checkout_item_details( array( 'title', 'remove' ) ) as $detail ) : ?>
					<?php it_exchange_get_template_part( 'super-widget-checkout/items/details/' . $detail ); ?>
				<?php endforeach; ?>
			</div>
			<div class="item-info">
				<?php foreach( it_exchange_get_super_widget_checkout_item_details( array( 'price' ) ) as $detail ) : ?>
					<?php it_exchange_get_template_part( 'super-widget-checkout/items/details/' . $detail ); ?>
				<?php endforeach; ?>
			</div>
