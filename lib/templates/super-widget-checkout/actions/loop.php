...
<div class="cart-actions-wrapper <?php echo $actions_count; ?>">
	<?php if ( it_exchange_is_multi_item_cart_allowed() && it_exchange_get_cart_products_count() > 1 ) : ?>
		<?php it_exchange_get_template_part( 'super-widget-checkout/actions/detials/multi-item-cancel' ); ?>
		<?php it_exchange_get_template_part( 'super-widget-checkout/actions/detials/multi-item-checkout' ); ?>
	<?php else : ?>
		<?php it_exchange_get_template_part( 'super-widget-checkout/actions/details/single-item-update-coupons' ); ?>
		<?php it_exchange_get_template_part( 'super-widget-checkout/actions/details/single-item-update-quantity' ); ?>
	<?php endif; ?>
</div>
