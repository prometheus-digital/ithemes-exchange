...
<h4>
<?php foreach( it_exchange_get_template_part_slugs( 'content_purchases', 'product_fields', array( 'product-title', 'product-subtotal', 'product-count' ) ) as $detail ): ?>
	<?php it_exchange_get_template_part( 'content-purchases/details/product-fields/' . $detail ); ?>
<?php endforeach; ?>
</h4>
<p>
<?php foreach( it_exchange_get_template_part_slugs( 'content_purchases', 'fields', array( 'product-description' ) ) as $detail ): ?>
	<?php it_exchange_get_template_part( 'content-purchases/details/product-fields/' . $detail ); ?>
<?php endforeach; ?>
</p>
