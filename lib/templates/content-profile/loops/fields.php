...
<?php do_action( 'it_exchange_content_profile_before_fields_loop' ); ?>
	...
	<?php do_action( 'it_exchange_content_profile_begin_fields_loop' ); ?>
		<?php foreach ( it_exchange_get_template_part_elements( 'content_profile', 'fields', array( 'first-name', 'last-name', 'email', 'nickname', 'website', 'password1', 'password2' ) ) as $field ) : ?>
			<?php
			/**
