...
$url             = add_query_arg( it_exchange_get_action_var( 'remove_product_from_cart' ), $cart_product_id );
$url             = wp_nonce_url( $url, 'it_exchange_remove_product_from_cart-' . $cart_product_id );
?>
