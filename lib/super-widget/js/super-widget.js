...
jQuery( function( $ ) {
	...
	var $sw = $('.it-exchange-super-widget');
	...
	$sw.on( 'click', '.payment-methods-wrapper form[data-type="iframe"] .it-exchange-purchase-button', function ( e ) {
		...
		var $this = $( this ),
			...
			$selector = $( '.it-exchange-payment-tokens-selector--list[data-method]', $form );
	...
	$sw.on( 'change', '.it-exchange-payment-tokens-selector--list input[type="radio"]', function ( e ) {
