...
jQuery( function() {
	...
	$sw.on('input keyup change', 'input.product-cart-quantity', function(event) {
		event.preventDefault();
		var product  = jQuery( this ).data('cart-product-id');
	...
	$sw.on( 'click', '.it-exchange-new-address--billing', function(e) {
		jQuery( '.it-exchange-sw-billing-address-form' ).show();
	} );
});
