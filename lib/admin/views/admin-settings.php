...
<div class="wrap">
	...
	?>
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"><label for="it_exchange_settings-company_name"><?php _e( 'Company Name' ) ?></label></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><label for="it_exchange_company_settings-tax_id"><?php _e( 'Company Tax ID' ) ?></label></th>
				<td>
					<?php $form->add_text_box( 'company_tax_id', array( 'class' => 'normal-text' ) ); ?>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="it_exchange_company_settings-email"><?php _e( 'Company Email' ) ?></label></th>
				<td>
					<?php $form->add_text_box( 'company_email', array( 'class' => 'normal-text' ) ); ?>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="it_exchange_company_settings-phone"><?php _e( 'Company Phone' ) ?></label></th>
				<td>
					<?php $form->add_text_box( 'company_phone', array( 'class' => 'normal-text' ) ); ?>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="it_exchange_company_settings-address"><?php _e( 'Company Address' ) ?></label></th>
				<td>
					<?php $form->add_text_area( 'company_address', array( 'rows' => 5, 'cols' => 30 ) ); ?>
				</td>
			</tr>
			<?php do_action( 'it_exchange_general_settings_before_settings-currency', $form ); ?>
			<tr valign="top">
				<th scope="row"><strong><?php _e( 'Currency Settings', 'LION' ); ?></strong></th>
				<td></td>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="it_exchange_settings-default_currency"><?php _e( 'Default Currency' ) ?></label></th>
				<td>
					<?php $form->add_drop_down( 'default_currency', $this->get_default_currency_options() ); ?>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="it_exchange_settings-currency_symbol_position"><?php _e( 'Symbol Position' ) ?></label></th>
				<td>
					<?php 
			...
			<tr valign="top">
				<th scope="row"><label for="it_exchange_currency_thousands_separator"><?php _e( 'Thousands Separator' ) ?></label></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><label for="it_exchange_currency_decimals_separator"><?php _e( 'Decimals Separator' ) ?></label></th>
				<td>
