...
?>
	...
	<div class="spacing-wrapper bottom-border clearfix hide-if-no-js transaction-actions">
		<?php if ( it_exchange_transaction_status_can_be_manually_changed( $txn ) && $options = it_exchange_get_status_options_for_transaction( $txn ) ): ?>
			...
			<div id="it-exchange-update-transaction-status-failed"><p><?php _e('Not Saved.', 'it-l10n-ithemes-exchange' ); ?></p></div>
			<div id="it-exchange-update-transaction-status-success"><p><?php _e( 'Saved!', 'it-l10n-ithemes-exchange' ); ?></p></div>
		<?php endif; ?>
