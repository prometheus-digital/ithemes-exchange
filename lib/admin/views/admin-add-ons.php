		...
		<?php if ( ! empty( $addons ) ) : ?>
			<?php if ( $propack ) { ?>
				<div class="add-on-block pro-pack">
					...
					<p><?php _e( 'The Pro Pack gets you access to all the iThemes Exchange add-ons... like Membership, Invoices, Variants, Easy U.S. Sales Taxes, Recurring Payments, Stripe, and MailChimp add-ons. Add-ons unlock so much more that Exchange can do. And with the Pro Pack you get access to all our iThemes-built add-ons, plus any more we build in the next year (which will be a lot).', 'LION' ); ?></p>
