	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td>
				...
				echo '<li>shipping_address - ' . __( 'The shipping address for this product. Blank if shipping is not required. Also accepts "before" and "after" arguments.', 'LION' ) . '</li>';
				echo '<li>billing_address - ' . __( 'The billing address for this product. Blank if shipping is not required. Also accepts "before" and "after" arguments.', 'LION' ) . '</li>';
				...
				echo '<li>account_link - ' . __( 'Adds a link to the customer\'s account page on your website.', 'LION' ) . '</li>';
