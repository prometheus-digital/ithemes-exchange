jQuery(document).ready(function($) {
	...
	*/	
	...
	$( '#it_exchange_advanced-sortables' ).prepend( '<a href id="it-exchange-advanced-tabs-toggle" class="button button-large advanced-hidden">' + addEditProductL10n.advanced + '</a>' );
