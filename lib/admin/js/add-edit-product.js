jQuery(document).ready(function($) {
	...
	*/	
	...
	$( '#it-exchange-advanced-tabs' ).tabs().css( 'display', 'none' );
	...
	$( '#base-price' ).on( 'focusout', function() {
		if ( $( this ).attr( 'data-symbol-position') == 'before' )
			$( this ).val( $( this ).attr( 'data-symbol') + it_exchange_number_format( $( this ).val(), 2, $( this ).attr( 'data-decimals-separator' ), $( this ).attr( 'data-thousands-separator' ) ) );
		else
			$( this ).val( it_exchange_number_format( $( this ).val(), 2, $( this ).attr( 'data-decimals-separator' ), $( this ).attr( 'data-thousands-separator' ) ) + $( this ).attr( 'data-symbol' ) );
	});
});
