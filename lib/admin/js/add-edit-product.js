jQuery(document).ready(function($) {
	...
	$('.categorydiv').each( function(){
		...
		$('a', '#' + taxonomy + '-tabs').live('click', function(){ //changed
		...
		$('#' + taxonomy + '-add-submit').live('click', function(){ //changed
			$('#new' + taxonomy).focus(); 
		});

		$('#' + taxonomy + '-add-toggle').live('click', function() { //changed
	...
	$('.categorydiv').each( function(){
		...
		$('#' + taxonomy + 'checklist, #' + taxonomy + 'checklist-pop').live('click', 'li.popular-category > label input[type="checkbox"]', function( event ) { //changed
			event.preventDefault();
