...
class IT_Exchange_Product_Feature_Product_Availability {
	...
	*/
	function save_feature_on_product_save() {
		...
		if ( ! isset( $_POST['_it-exchange-product-availability'] ) )
			return;

		// Get new value from post
		$new_value = $_POST['_it-exchange-product-availability'];
		
		// Save new value
		it_exchange_update_product_feature( $product_id, 'product-availability', $new_feature );
	}
