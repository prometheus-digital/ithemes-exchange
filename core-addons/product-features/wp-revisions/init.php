<?php
/**
 * This add-on will enable the revisions metabox on the edit add / edit product page
 *
...
add_action( 'it_cart_buddy_enabled_addons_loaded', 'it_cart_buddy_init_wp_revisions_addon' );
 ...
 * @since 0.3.8
*/
function it_cart_buddy_init_wp_revisions_addon() {
	// Register the product feature
	$this_addon  = it_cart_buddy_get_addon( 'wp-revisions' );
