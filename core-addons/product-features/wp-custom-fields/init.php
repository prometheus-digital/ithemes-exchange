<?php
/**
 * This add-on will enable the custom fields metabox on the edit add / edit product page
 *
...
add_action( 'it_cart_buddy_enabled_addons_loaded', 'it_cart_buddy_init_wp_custom_fields_addon' );
 ...
 * @since 0.3.8
*/
function it_cart_buddy_init_wp_custom_fields_addon() {
	// Register the product feature
	$this_addon  = it_cart_buddy_get_addon( 'wp-custom-fields' );
