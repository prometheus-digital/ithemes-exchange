...
add_action( 'it_cart_buddy_enabled_addons_loaded', 'it_cart_buddy_init_wp_featured_image_addon' );
add_filter( 'it_cart_buddy_get_product_feature-wp-featured-image', 'it_cart_buddy_wp_featured_image_addon_get_featured_image', 9, 2 );
 ...
 * @since 0.3.8
*/
function it_cart_buddy_init_wp_featured_image_addon() {
	// Register the product feature
	$this_addon  = it_cart_buddy_get_addon( 'wp-featured-image' );
...
*/
function it_cart_buddy_wp_featured_image_addon_get_featured_image( $featured_image, $product_id ) {
