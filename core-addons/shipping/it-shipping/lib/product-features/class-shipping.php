	...
	function print_metabox( $post ) {
		...
		<div class="shipping-header">
			<div class="shipping-label">
				<label><?php _e( 'Shipping', 'LION' ); ?> <span class="tip" title="<?php _e( 'Set shipping details for the product here.', 'LION' ); ?>">i</span></label>
			</div>

			<div class="shipping-toggle">
				<label id="it-exchange-shipping-disabled-label" for="it-exchange-shipping-disabled">
					<input type="checkbox" id="it-exchange-shipping-disabled" name="it-exchange-shipping-disabled" /> <?php _e( 'Disable shipping for this product', 'LION' ); ?>
		...
		<div class="shipping-feature shipping-core">
			<div class="standard-shipping-flat-rate-cost">
				<label><?php _e( 'Flat Rate Shipping Cost', 'LION' ); ?> <span class="tip" title="<?php _e( 'Shipping costs for this product. Multiplied by quantity purchased.', 'LION' ); ?>">i</span></label>
				<input type="text" id="it-exchange-flat-rate-shipping-cost" name="it-exchange-flat-rate-shipping-cost" value="$5.00"/>
			</div>
		</div>
		...
		<div class="shipping-feature shipping-weight-dimensions">
			<div class="shipping-weight">
				...
				<input type="text" id="it-exchange-shipping-weight" name="it-exchange-weight" value="12"/>
			...
			<div class="shipping-dimensions">
				...
				<input type="text" id="it-exchange-shipping-length" name="it-exchange-length" value="48"/>
				<span class="it-exchange-shipping-dimensions-times">&times;</span>
				<input type="text" id="it-exchange-shipping-width" name="it-exchange-width" value="18"/>
				<span class="it-exchange-shipping-dimensions-times">&times;</span>
				<input type="text" id="it-exchange-shipping-height" name="it-exchange-height" value="4"/>
