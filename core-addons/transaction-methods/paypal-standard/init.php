	...
	function get_paypal_standard_payment_form_table( $form, $settings = array() ) {
		...
		<div class="it-exchange-addon-settings it-exchange-paypal-addon-settings">
            <p>
				...
				<?php _e( 'Video:', 'LION' ); ?>&nsbp;<a href="http://ithemes.com/tutorials/setting-up-paypal-standard-basic/" target="_blank"><?php _e( 'Setting Up PayPal Standard Basic', 'LION' ); ?></a>
			</p>
