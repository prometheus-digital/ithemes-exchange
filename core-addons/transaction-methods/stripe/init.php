	...
	*/
	...
	function get_stripe_payment_form_table( $form, $settings = array() ) {
		...
		<div class="it-exchange-addon-settings it-exchange-stripe-addon-settings">
            ...
            <p><?php _e( 'To get Stripe setup for your ecommerce site, you will need to do a couple of things in Stripe first.<br /><br />

<a href="http://ithemes.com/tutorial/category/exchange" target="_blank">Video: Getting Stripe Setup with Exchange</a>', 'LION' ); ?></p>
