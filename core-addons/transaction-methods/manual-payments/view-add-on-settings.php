...
<div class="wrap">
	...
	<?php $form->start_form( $form_options, 'cart-buddy-manual-payments-settings' ); ?>
		...
		<table class="form-table">
			<?php do_action( 'it_cart_buddy_manual_payments_settings_table_top' ); ?>
			<tr valign="top">
			...
			<?php do_action( 'it_cart_buddy_manual_payments_settings_table_bottom' ); ?>
		</table>
		<?php do_action( 'it_cart_buddy_manual_payments_settings_form_bottom' ); ?>
		<p class="submit">
			<?php $form->add_submit( 'submit', array( 'value' => __( 'Save Changes', 'LION' ), 'class' => 'button button-primary' ) ); ?>
		</p>
	<?php $form->end_form(); ?>
	<?php do_action( 'it_cart_buddy_manual_payments_settings_page_bottom' ); ?>
</div>
<?php
