...
function it_exchange_register_addon( $slug, $params ) {
	...
	if ( ! $slug  )
		return new WP_Error( 'it_exchange_add_registration_error', __( 'All iThemes Exchange Add-ons require a slug parameter.', 'LION' ) );

	if ( ! $name )
		return new WP_Error( 'it_exchange_add_registration_error', __( 'All iThemes Exchange Add-ons require a name parameter.', 'LION' ) );

	if ( ! $file )
		return new WP_Error( 'it_exchange_add_registration_error', __( 'All iThemes Exchange Add-ons require a file parameter.', 'LION' ) );
...
function it_exchange_register_addon_category( $slug, $name, $description, $options = array() ) {
	...
	if ( ! $slug  )
		return new WP_Error( 'it_exchange_add_registration_error', __( 'All iThemes Exchange Add-on categories require a slug parameter.', 'LION' ) );

	if ( ! $name )
		return new WP_Error( 'it_exchange_add_registration_error', __( 'All iThemes Exchange Add-ons categories require a name parameter.', 'LION' ) );
