...
function it_exchange_get_currencies() {
	$currencies = array(
		...
		'MZN' => array( 'symbol' => 'MT', 'name' => __( 'Mozambique Metical', 'LION' ) ),
		...
		'STD' => array( 'symbol' => 'STD', 'name' => __( 'S&#227;o Tom&#233; and Pr&#237;ncipe Dobra', 'LION' ) ),
		'SVC' => array( 'symbol' => '$', 'name' => __( 'El Salvador Colon', 'LION' ) ),
		...
		'TOP' => array( 'symbol' => 'T$', 'name' => __( "Tonga Pa'anga", 'LION' ) ),
		...
		'VEF' => array( 'symbol' => 'Bs', 'name' => __( 'Venezuela Bolivar', 'LION' ) ),
		...
		'ZMW' => array( 'symbol' => 'ZK', 'name' => __( 'Zambian kwacha', 'LION' ) ),
